...
Route::put('/items/{id}/hide', [DisplayController::class, 'hide'])->name('hide');
//Route::put('/items/{id}/restore', [DisplayController::class, 'restore'])->name('restore');
...
Route::get('/business-edit', [DisplayController::class, 'busiedit_index'])->name('busiedit');
...
Route::get('/top-1', 'ItemController@index')->name('items.index');
